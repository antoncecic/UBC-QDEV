...
# This program allows a user to analyze the power spectral density of a FastDAC's ADC channels.  
# The code is written in Python and uses a Dash (by Plotly) based interface with built in controls over various input parameters.
...
# If you plan on accessing the interface on a different device, both the computer and the device 
